...
import Graphics.Fondo;
import Graphics.Moneda;
import Graphics.Personaje;
import Graphics.Tubos;
...
public class Juego extends JPanel{
	...
	Tubos wall2 = new Tubos(WIDTH + (WIDTH / 4));	
        ...
        private Sound sound= new Sound("/Sonidos/menu.wav");
        int Score=0;
	public static int monedas = 0;						
	static int scrollX = 0;						
	public static boolean dead = false;					
	public static String deathMessage = "" ; 				
        static File floor1 = new  File("/Imagenes/floor.png");
