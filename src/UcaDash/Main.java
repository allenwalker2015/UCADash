...
import javax.swing.Timer;
	...
	public class Main {
 	static JFrame frame = new JFrame();		
		...
		frame.setSize(Juego.WIDTH, Juego.HEIGHT);					//declares the JFrame (window) that all of this is housed in
	...
	public static void runnit() throws InterruptedException{
		...
		final Juego game = new Juego();							//the game used in each instance
