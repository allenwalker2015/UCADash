...
import javax.swing.Timer;
	...
	public class Main {
 	static JFrame frame = new JFrame();		
		...
		frame.setSize(Nivel1.WIDTH, Nivel1.HEIGHT);					//declares the JFrame (window) that all of this is housed in
	...
	public static void runnit() throws InterruptedException{
		...
		final Nivel1 game = new Nivel1();							//the game used in each instance
